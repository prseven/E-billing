...
?>
		...
		<form method="post" id="create_invoice">
			...
			<div class="row">
				<div class="col-xs-12">
					<textarea name="custom_email" id="custom_email" class="custom_email_textarea" placeholder="E-mail."></textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-4">
				...
				<div class="col-xs-8 text-right">
					...
					<div class="input-group col-xs-4 float-right">
						...
						<input type="number" name="invoice_id" id="invoice_id" class="form-control required" placeholder="Invoice Number" aria-describedby="sizing-addon1" value="<?php getInvoiceId(); ?>">
					</div>
				</div>
			</div>
			<div class="row">
							...
							<div class="row">
								<div class="col-xs-6">
									...
									<div class="form-group no-margin-bottom">
										<input type="number" class="form-control copy-input required" name="customer_postcode" id="customer_postcode" placeholder="Postcode" tabindex="7">					
									</div>
								</div>
								<div class="col-xs-6">
								    ...
								    <div class="form-group">
								    	<input type="text" class="form-control margin-bottom copy-input required" name="customer_county" id="customer_county" placeholder="State" tabindex="6">
								    </div>
								    <div class="form-group no-margin-bottom">
								    	<input type="number" class="form-control required" name="customer_phone" id="customer_phone" placeholder="Phone number" tabindex="8">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="panel-body form-group form-group-sm">
							<div class="row">
								<div class="col-xs-6">
									...
									<div class="form-group no-margin-bottom">
										<input type="text" class="form-control required" name="customer_county_ship" id="customer_county_ship" placeholder="State" tabindex="13">
									</div>
								</div>
								<div class="col-xs-6">
									<div class="form-group">
								    ...
								    <div class="form-group no-margin-bottom">
								    	<input type="number" class="form-control required" name="customer_postcode_ship" id="customer_postcode_ship" placeholder="Postcode" tabindex="14">
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-xs-6 no-padding-right">
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<div class="input-group input-group-sm">
								<span class="input-group-addon"><?php echo CURRENCY ?></span>
								<input type="number" class="form-control calculate shipping" name="invoice_shipping" aria-describedby="sizing-addon1" placeholder="0.00">
							</div>
						</div>
					</div>
