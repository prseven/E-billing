...
if ($action == 'download_csv'){
    ...
    if ($result_column_data = mysqli_query($mysqli, $query_table_columns_data)) {
		echo json_encode(array(
			'status' => 'Success',
			'message'=> 'CSV has been generated and is available in the /invoice/downloads folder for future reference, you can download by <a href="/invoice/downloads/'.$file_name.'">clicking here</a>.'
		));
